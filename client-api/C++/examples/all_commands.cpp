...
int main()
{
    ...
    VIBES_TEST( vibes::drawPie(0,10,3,4,20, 120, "black[red]") );
    VIBES_TEST( vibes::drawPie(0,5,3,1,-20, -220, "black[red]") );
    VIBES_TEST( vibes::drawPie(10,-13,3,4,700, 800, "black[red]") );
    VIBES_TEST( vibes::drawPie(0,15,3,3,20, 120, "black[red]") ); 
